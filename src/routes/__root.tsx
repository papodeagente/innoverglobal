...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Innover Global Access provides bilingual international trade consulting for Brazilian SMEs." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Innover" },
      { property: "og:locale", content: "pt_BR" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#0A2540" },
      { name: "twitter:title", content: "Innover — Consultoria em Comércio Exterior" },
      { name: "description", content: "Innover Global Access provides bilingual international trade consulting for Brazilian SMEs." },
      { name: "twitter:description", content: "Innover Global Access provides bilingual international trade consulting for Brazilian SMEs." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/9bde7dd9-cd1b-4206-bb52-ec6366fdfd58/id-preview-a9598810--8b919a75-bc91-4d73-a15c-1903c365d0b2.lovable.app-1778714838313.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/9bde7dd9-cd1b-4206-bb52-ec6366fdfd58/id-preview-a9598810--8b919a75-bc91-4d73-a15c-1903c365d0b2.lovable.app-1778714838313.png" },
    ],
    links: [
